...
const SkillsStyled = styled.div`
  ...
  @media (min-width: 541px) {
    .grid-wrapper-small {
      grid-template-rows: auto repeat(3, 300px) repeat(3, 260px);
      width: 65%;
      grid-row-gap: 25px;
    }
    ...
    return (
        <SkillsStyled id="skills">
            <Wrapper>
                <div className="grid-wrapper grid-wrapper-small">
                    ...
                    <div className="skill-blocks-small">
                        <div className="skill-card-grid">
                            <div className="skill-grid-img-1 skill-grid-img-small">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 549">
                                        <path fill="#01EC64"
                        ...
                        <div className="skill-card-grid">
                            <div className="skill-grid-img-1 skill-grid-img-small">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 349">
                                        <path fill="#00758F"
                ...
                <div className="grid-wrapper grid-wrapper-big">
                    <div className="skill-blocks">
                        <div className="skill-card-grid">
                            <div className="skill-grid-img-1">
                                <div>
                    ...
                    <div className="skill-blocks-small-container">
                        <div className="skill-blocks-small">
                            <div className="skill-card-grid">
                                <div className="skill-grid-img-1 skill-grid-img-small">
                                    <div>
